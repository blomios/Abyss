...
public class mine : MonoBehaviour {
    ...
    public GameObject explosionBaril;
    public static bool minePlanted = false;
    public AudioClip[] priseDegats;


    public int pointsPerBalle = 100;
    ...
    private void CheckIfDied()
    {
        ...
        if (vie <= 0)
        {
            ...
            Instantiate(explosionBaril, transform.position, randomRotation);
            minePlanted = false;
            questLvl2.mineUsed = true;
            questLvl2.quest4Ok = true;
            Destroy(gameObject);
        }
    }
}
